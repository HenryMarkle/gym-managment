            ...
            <div className="right w-[50%] mb-[5px] flex flex-col gap-8 justify-center">
              ...
              <div className="name w-[95%] flex flex-col">
                ...
                <input
                  ...
                  value={new Date(user.startDate).toLocaleDateString("tr-GB")}
                  disabled={isEditing ? false : true}
                />
              </div>
              <div className="name w-[95%] flex flex-col">
              ...
              <button
                disabled={!isEditing}
                className="submit-btn bg-customRed w-[65%] text-center mt-5 p-3 font-bold rounded-[31px] text-white shadow-md"
              >
                Update
              </button>
            </div>
